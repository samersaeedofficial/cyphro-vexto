...
// ----------------- Input Component -----------------
const Input = React.forwardRef(({ className, type = "text", value, defaultValue, ...props }, ref) => {
    ...
    return (
        <div className="relative group">
            <input
                ...
                ref={ref}
                {...inputProps} // Only pass one of them
                {...props}      // Pass the rest (onChange, placeholder, etc.)
            />
            <div
